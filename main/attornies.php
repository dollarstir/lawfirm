                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="footer footer-two">
                                ...
                                <ul>
                                    <li>
                                        <a href="main/blog.html#">Criminal law</a>
                                    </li>
                                    <li>
                                        <a href="main/blog.html#">Accident law</a>
                                    </li>
                                    <li>
                                        <a href="main/blog.html#">Devorce law</a>
                                    </li>
                                    <li>
                                        <a href="main/blog.html#">Industrial law</a>
                                    </li>
                                    <li>
                                        <a href="main/blog.html#">Business law</a>
                                    </li>
                                    <li>
                                        <a href="main/blog.html#">Familly law</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
