                            ...
                            <div class="main-menu-area">
                                <nav>
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <ul>
                                                ...
                                                <li class="has-child-menu">
                                                    <a href="single-practice.html#">Demo</a>
                                                    <ul class="thired-level">
                                                        <li>
                                                            <a href="single-practice.html#">Demo 1</a>
                                                        </li>
                                                        <li>
                                                            <a href="single-practice.html#">Demo 2</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                            </ul>
                                        ...
                                        <li>
                                            <a href="single-practice.html#">Pages</a>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="make-appointment">
                            ...
                            <a href="single-practice.html#">Make An Appointment</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="footer footer-two">
                                ...
                                <ul>
                                    <li>
                                        <a href="single-practice.html#">Criminal law</a>
                                    </li>
                                    <li>
                                        <a href="single-practice.html#">Accident law</a>
                                    </li>
                                    <li>
                                        <a href="single-practice.html#">Devorce law</a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="single-practice.html#">Familly law</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
