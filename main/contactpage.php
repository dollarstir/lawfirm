                                        ...
                                        <li>
                                            ...
                                            <ul>
                                                ...
                                                <li class="has-child-menu">
                                                    <a href="contact.html#">Demo</a>
                                                    <ul class="thired-level">
                                                        <li>
                                                            <a href="contact.html#">Demo 1</a>
                                                        </li>
                                                        <li>
                                                            <a href="contact.html#">Demo 2</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                            </ul>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="footer footer-two">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="contact.html#">Accident law</a>
                                    </li>
                                    <li>
                                        <a href="contact.html#">Devorce law</a>
                                    </li>
                                    <li>
                                        <a href="contact.html#">Industrial law</a>
                                    </li>
                                    <li>
                                        <a href="contact.html#">Business law</a>
                                    </li>
                                    <li>
                                        <a href="contact.html#">Familly law</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
