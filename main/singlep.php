                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="footer footer-two">
                                ...
                                <ul>
                                    <li>
                                        <a href="main/single-practice.html#">Criminal law</a>
                                    </li>
                                    <li>
                                        <a href="main/single-practice.html#">Accident law</a>
                                    </li>
                                    <li>
                                        <a href="main/single-practice.html#">Devorce law</a>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <a href="main/single-practice.html#">Familly law</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
